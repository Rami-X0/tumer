...
class GetAllMessagePatientScreen extends StatefulWidget {
  final String name;
  final String receiverId;

  const GetAllMessagePatientScreen(
      {super.key, required this.name, required this.receiverId});

  @override
  State<GetAllMessagePatientScreen> createState() =>
      _GetAllMessagePatientScreenState();
}

final ValueNotifier<File?> _imageNotifier = ValueNotifier<File?>(null);

class _GetAllMessagePatientScreenState
    extends State<GetAllMessagePatientScreen> {
  @override
  Widget build(BuildContext context) {
    print('buildddd1');
    return BlocProvider.value(
      value: getIt<PatientCubit>()..getAllMessages(widget.receiverId),
      child: AppScaffold(
        appBar: AppBar(
    ...
    return Padding(
      ...
      child: Form(
        child: AppTextFormField(
          ...
          suffixIcon: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    getIt<PatientCubit>().sendMessages(widget.receiverId);
                    // getIt<PatientCubit>().getAllMessages(widget.receiverId);
                  },
                  child: FaIcon(
          ...
          controller: PatientCubit.messageControllerText,
        ),
      ),
    );
  }
